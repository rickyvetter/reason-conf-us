...
# 140 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 143 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 221 "reactjs_jsx_ppx_v3.cppo.ml"
  let fileName = String.capitalize fileName in
  
# 223 "reactjs_jsx_ppx_v3.cppo.ml"
  fileName
...
# 260 "reactjs_jsx_ppx_v3.cppo.ml"
    {
      ptyp_loc = loc;
      ptyp_attributes = [];
...
# 270 "reactjs_jsx_ppx_v3.cppo.ml"
    (* ~foo: int=1 *)
    | (label, Some type_, Some _) ->
    
# 275 "reactjs_jsx_ppx_v3.cppo.ml"
    {
      type_ with
      ptyp_desc = Ptyp_constr ({loc; txt=optionIdent}, [type_]);
    }
    
# 280 "reactjs_jsx_ppx_v3.cppo.ml"
    (* ~foo: option(int)=? *)
...
# 288 "reactjs_jsx_ppx_v3.cppo.ml"
    {
      type_ with
      ptyp_desc = Ptyp_constr ({loc; txt=optionIdent}, [type_]);
    }
    
# 293 "reactjs_jsx_ppx_v3.cppo.ml"
    (* ~foo=? *)
    | (label, None, _) when isOptional label ->
    
# 302 "reactjs_jsx_ppx_v3.cppo.ml"
    {
      ptyp_loc = loc;
      ptyp_attributes = [];
      ptyp_desc = Ptyp_constr ({loc; txt=optionIdent}, [{
...
# 312 "reactjs_jsx_ppx_v3.cppo.ml"
    (* ~foo *)
    | (label, None, _) ->
    {
      ptyp_desc = Ptyp_var (safeTypeFromValue label);
...
# 374 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 384 "reactjs_jsx_ppx_v3.cppo.ml"
        ptyp_desc = Ptyp_object(namedTypeList, Closed);
        
# 386 "reactjs_jsx_ppx_v3.cppo.ml"
        ptyp_loc = loc;
        ptyp_attributes = [];
      }])
    )
...
let makeTypeExp ~fnName ~loc manifest namedTypeList =
  ...
  Str.mk @@ Pstr_type [Type.mk ~params ~manifest { loc; txt = fnName}]
...
let jsxMapper () =
  ...
  let transformUppercaseCall3 modulePath mapper loc attrs _ callArguments =
    ...
    let mapper exp = (Exp.apply
          ~loc
          ~attrs
          (Exp.ident ~loc {loc; txt = Ldot (Lident "React", "staticify")})
          ([
            (nolabel, exp)
          ])) in
    let (jsxCall, args) = (match childrenExpr with
        | Exact children -> ("jsx", [(labelled "children", children)])
        | ListLiteral ({ pexp_desc = Pexp_array list }) when list = [] -> ("jsxs", [])
        | ListLiteral ({ pexp_desc = Pexp_array list } as expression) ->
        ("jsxs", [(labelled "children", (Exp.apply
          ~loc
          ~attrs
          (Exp.ident ~loc {loc; txt = Ldot (Lident "React", "arrayJSXONLY")})
          ([
            (nolabel, { expression with pexp_desc = Pexp_array (List.map mapper list)})
          ])))])) in
...
# 445 "reactjs_jsx_ppx_v3.cppo.ml"
    let capped = String.uppercase first in first = capped in
    
# 447 "reactjs_jsx_ppx_v3.cppo.ml"
    ...
    | Some key -> (Exp.apply
      ~loc
      ~attrs
      (Exp.ident ~loc {loc; txt = Ldot (Lident "React", jsxCall ^ "Keyed")})
      ([
    ...
    let transformLowercaseCall3 mapper loc attrs callArguments id =
      ...
      | Some key -> 
        ...
        ~loc
        ~attrs
        (Exp.ident ~loc {loc; txt = Ldot (Lident "ReactDOMRe", jsxCall ^ "Keyed")})
        ([
      ...
      | None -> (Exp.apply
        ~loc
        ~attrs
        (Exp.ident ~loc {loc; txt = Ldot (Lident "ReactDOMRe", jsxCall)})
        ([
          (nolabel, componentNameExpr);
          (nolabel, props)
        ])))
...
# 611 "reactjs_jsx_ppx_v3.cppo.ml"
    | Pexp_fun ("key", _, _, _)
...
# 616 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 645 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 650 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 694 "reactjs_jsx_ppx_v3.cppo.ml"
  (getLabel name, [], type_) :: types
    
# 696 "reactjs_jsx_ppx_v3.cppo.ml"
    | _ -> types
  in
...
# 720 "reactjs_jsx_ppx_v3.cppo.ml"
      | Ptyp_arrow ("", _type, rest) ->
        
# 722 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 782 "reactjs_jsx_ppx_v3.cppo.ml"
        ...
        (Some externalDecl, propsType, newBinding)
      else
        (None, None, binding)
      in
      let structuresAndBinding = List.map mapBinding valueBindings in
      let otherStructures (extern, propType, binding) (externs, propTypes, bindings) =
        ...
        | None -> propTypes in
        (externs, propTypes, binding :: bindings)
      in
      let (externs, propTypes, bindings) = List.fold_right otherStructures structuresAndBinding ([], [], []) in
      List.concat([
        propTypes;
        externs;
        [{
...
# 938 "reactjs_jsx_ppx_v3.cppo.ml"
      | Ptyp_arrow ("", _type, rest) ->
        
# 940 "reactjs_jsx_ppx_v3.cppo.ml"
        getPropTypes types rest
...
# 1074 "reactjs_jsx_ppx_v3.cppo.ml"
          | ((_, {pexp_desc = Pexp_constant (Const_int version)})::_rest, recordFieldsWithoutJsx) -> begin
              
# 1076 "reactjs_jsx_ppx_v3.cppo.ml"
              (match version with
              
# 1081 "reactjs_jsx_ppx_v3.cppo.ml"
              | 2 -> jsxVersion := Some 2
              | 3 -> jsxVersion := Some 3
              
# 1084 "reactjs_jsx_ppx_v3.cppo.ml"
...
# 1165 "reactjs_jsx_ppx_v3.cppo.ml"

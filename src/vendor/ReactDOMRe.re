...
external render: (React.element('any), Dom.element) => unit = "render";
...
[@bs.val] [@bs.module "react-dom"]
external hydrate: (React.element('any), Dom.element) => unit = "hydrate";
...
[@bs.val] [@bs.module "react-dom"]
external createPortal: (React.element('any), Dom.element) => React.element('any) =
  "createPortal";
...
external objToDOMProps: Js.t({..}) => props('a) = "%identity";
...
[@bs.module "react"]
external jsxKeyed: (string, domProps('a), string) => React.element(React.keyed) = "jsx";

[@bs.module "react"]
external jsxsKeyed: (string, domProps('a), string) => React.element(React.keyed) = "jsxs";


[@bs.module "react"]
external jsx: (string, domProps('a)) => React.element(React.unkeyed) = "jsx";

[@bs.module "react"]
external jsxs: (string, domProps('a)) => React.element(React.unkeyed) = "jsxs";